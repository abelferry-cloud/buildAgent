...
| [s06](./s06-compact/) | Compact | `agent/core/compact.py` | ✅ 完成（已测试） |
| [s07](./s07-tasks/) | Tasks | `agent/core/tasks.py` | ✅ 完成（已测试） |
| [s08](./s08-background/) | Background Tasks | `agent/core/background.py` | ✅ 完成（已测试） |
| [s09](./s09-teams/) | Agent Teams | `agent/core/teams.py` | ✅ 完成（已测试） |
| [s10](./s10-protocols/) | Team Protocols | `agent/core/protocols.py` | ✅ 完成（已测试） |
| [s11](./s11-autonomous/) | Autonomous Agents | `agent/core/autonomous.py` | ✅ 完成（已测试） |
| [s12](./s12-worktree/) | Worktree + Isolation | `agent/core/worktree.py` | ✅ 完成（已测试） |
