...
| [s02](./s02-tools/) | Tools | `agent/core/dispatch.py` | ❌ 未完成 |
| [s03](./s03-todowrite/) | TodoWrite | `agent/core/todo.py` | ❌ 未完成 |
| [s04](./s04-subagents/) | Subagents | `agent/core/subagent.py` | ❌ 未完成 |
| [s05](./s05-skills/) | Skills | `agent/skills/loader.py` | ❌ 未完成 |
